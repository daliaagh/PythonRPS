...
To get the starter code, go to this GitHub page. If you've never used GitHub, don't worry—just read the directions given in the README and download the files as described. If you want to download all the files at once, just click on the green Clone or download button and then click Download ZIP.
